...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "Oᴡɴᴇʀ", 'url' => "https://t.me/YourExDestiny"],
...
//=============PRICE===============//
if ($cdata2 == "price") {
    $priceText = "<b>\n" . str_repeat(' ', 2) ."𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗨𝗦𝗘𝗥 𝗣𝗥𝗜𝗖𝗘 𝗟𝗜𝗦𝗧" . str_repeat(' ', 20) . "\n═════════════════\n •├3 𝖣𝖠𝖸𝖲 𝖯𝖫𝖠𝖭⇢ 1💲\n •├7 𝖣𝖠𝖸𝖲 𝖯𝖫𝖠𝖭 ⇢ 3💲\n •├15 𝖣𝖠𝖸𝖲 𝖯𝖫𝖠𝖭 ⇢ 6💲\n •├30 𝖣𝖠𝖸𝖲 𝖯𝖫𝖠𝖭 ⇢ 10💲\n═════════════════\n •├Dev ➳ <code>@YourExDestiny</code>\n━━━━━━━━━━━━━━━━━━━</b>";

    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => 'Hᴏᴍᴇ🏡', 'callback_data' => 'back2'], ['text' => 'Bᴜʏ🛒', 'url' => 'https://t.me/YourExDestiny']]
        ]
    ]);
